<template>
  <div class="w-full bg-white rounded flex flex-col gap-1 overflow-hidden border border-blue-800/20">
    <button @click="collapse = !collapse"
      class="flex text-xs bg-blue-800/20 text-blue-800 px-1 justify-between">
