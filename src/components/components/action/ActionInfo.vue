<template>
  <div class="w-full bg-white rounded flex flex-col gap-1 overflow-hidden border border-pink-800/20">
    <button @click="collapse = !collapse"
      class="flex text-xs bg-pink-800/20 text-pink-800 px-1 justify-between">
...
import { ActionType, ActionProperties } from './types'
...
const compProps = computed(() => {
  return Object.keys(props.comp.properties) as Array<keyof ActionProperties>
})
